...
In early 2015, a step further was performed, with the addition of the [GNU ARM Eclipse OpenOCD][1] subproject, a new distribution of OpenOCD.
...
* the [GNU ARM Eclipse OpenOCD][1] debugging plug-in
...
If you did not do it yet, please follow the instructions in the [OpenOCD install][2] page and return when completed.
...
Before starting work with OpenOCD, it is recommended to define a global variable with the path to the folder where OpenOCD executables are located.
...
![](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDPath.png)
...
![OpenOCD debug configurations.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDDebugConfigs.png)
...
![The OpenOCD Main tab.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDMainTab.png)
...
![OpenOCD Debugger tab.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDDebuggerTab.png)
...
![The OpenOCD Startup tab.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDStartupTab.png)
...
![Shared debug configuration.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDCommonTab.png)


* this will arrange for the debug configuration to be saved in the project, not in the workspace storage

![Debug configuration stored in the project.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDSharedDebug.png)
...
![Down arrow debug.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDStartDebugArrow.png)
...
![The new debug session, with two consoles.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDConsoles.png)
...
![The GDB client console.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDclientConsole.png)


The semihosting tracing messages are displayed in the same window as the OpenOCD output:

![The tracing console.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDTraceConsole.png)
...
![Show console when standard out/err changes.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDShowConsole.png)
...
![Cannot run OpenOCD.](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/12/OpenOCDCannotRun.png)

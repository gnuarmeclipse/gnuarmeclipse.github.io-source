...
last_modified_at: 2015-09-11 23:57:00
...
In the main [project page][3], go to the Git → Second Edition.
...
Most probably you are running on Windows, and forgot to add the builder tools or to add the path to them. See the [Build Tools][4] page.
...
[![Screen Shot 2013-11-16 at 12.10.35](http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/10/Screen-Shot-2013-11-16-at-12.10.35.png)][5]
...
-/-
 ...
 [1]: /blog/build-tools-windows/ "Build tools (make & rm) on Windows"
 [2]: /blog/known-problems/ "Known problems"
 [3]: https://sourceforge.net/projects/gnuarmeclipse/
 [4]: /blog/build-tools-windows/
 [5]: http://gnuarmeclipse.livius.net/blog/wp-content/uploads/2013/10/Screen-Shot-2013-11-16-at-12.10.35.png